    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='accounts.trainer')),
            ],
        ),
        migrations.CreateModel(
            name='Hours',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dog_breed', models.CharField(choices=[('Bulldogs', 'Bulldogs'), ('Boerboel', 'Boerboel'), ('Chihuahua', 'Chihuahua'), ('Doberman', 'Doberman'), ('English Springer Spaniel', 'English Springer Spaniel'), ('German Shepherd', 'German Shepherd'), ('Maltese Terrier', 'Maltese Terrier'), ('Neapolitan Mastiff', 'Neapolitan Mastiff'), ('Retrievers(Labrador)', 'Retrievers(Labrador)'), ('Retrievers(Golden)', 'Retrievers(Golden)'), ('Rottweilers', 'Rottweilers')], max_length=200)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dogs', to='accounts.owner')),
            ],
        ),
        migrations.CreateModel(
            name='Clinic',
