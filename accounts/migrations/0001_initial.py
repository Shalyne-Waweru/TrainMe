    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('obedience', 'Obedience-Training'), ('trick', 'Trick_Skill_Training'), ('behavior', 'Behavior Modification'), ('puppy', 'Puppy Training'), ('security', 'Security Program'), ('anxiety', 'Separation Anxiety')], max_length=20), size=None)),
