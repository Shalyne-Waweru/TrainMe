# Generated by Django 4.1.2 on 2022-11-08 19:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.CharField(choices=[('Obedience Training', 'Obedience Training'), ('Trick Skill Training', 'Trick Skill Training'), ('Behavior Modification', 'Behavior Modification'), ('Puppy Training', 'Puppy Training'), ('Security Program', 'Security Program'), ('Separation Anxiety', 'Separation Anxiety')], max_length=255)),
